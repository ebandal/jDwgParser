...
/**
 * DIMENSION_RADIUS 엔티티 (타입 0x19)
 * 반지름 크기 지정
 */
public class DwgDimensionRadius extends AbstractDwgEntity {
    ...
    @Override
    public DwgObjectType objectType() { return DwgObjectType.DIMENSION_RADIUS; }
