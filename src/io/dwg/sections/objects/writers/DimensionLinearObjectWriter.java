...
public class DimensionLinearObjectWriter implements ObjectWriter {
    @Override
    ...
    public void write(DwgObject source, BitStreamWriter w, DwgVersion v) throws Exception {
        DwgDimensionLinear dim = (DwgDimensionLinear) source;
        ...
        w.writeBitDouble(dim.horizontalDirection());
