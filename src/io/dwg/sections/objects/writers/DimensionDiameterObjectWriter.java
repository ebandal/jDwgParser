...
import io.dwg.entities.concrete.DwgDimensionDiameter;
import io.dwg.sections.objects.ObjectWriter;

public class DimensionDiameterObjectWriter implements ObjectWriter {
    @Override
    public int objectType() { return DwgObjectType.DIMENSION_DIAMETER.typeCode(); }

    @Override
    public void write(DwgObject source, BitStreamWriter w, DwgVersion v) throws Exception {
        DwgDimensionDiameter dim = (DwgDimensionDiameter) source;
