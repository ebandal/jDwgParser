...
/**
 * DIMENSION_ANG_3PT 엔티티 (타입 0x17)
 * 각도 크기 지정 (3점으로 지정)
 */
public class DwgDimensionAng3pt extends AbstractDwgEntity {
    ...
    @Override
    public DwgObjectType objectType() { return DwgObjectType.DIMENSION_ANG_3PT; }
