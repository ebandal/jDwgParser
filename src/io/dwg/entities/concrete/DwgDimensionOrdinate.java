...
/**
 * DIMENSION_ORDINATE 엔티티 (타입 0x14)
 * 좌표 크기 지정 (X 또는 Y 좌표만 표시)
 */
public class DwgDimensionOrdinate extends AbstractDwgEntity {
    ...
    @Override
    public DwgObjectType objectType() { return DwgObjectType.DIMENSION_ORDINATE; }
