...
/**
 * DIMENSION_ANG_2LN 엔티티 (타입 0x18)
 * 각도 크기 지정 (2개 선으로 지정)
 */
public class DwgDimensionAng2ln extends AbstractDwgEntity {
    ...
    @Override
    public DwgObjectType objectType() { return DwgObjectType.DIMENSION_ANG_2LN; }
